...
export const useCourseRevisionStore = create<CourseRevisionState>((set, get) => ({
  currentCourse: null,
      ...
      set({
        courseOutcomes: courseOutcomes.map((outcome) => {
          ...
          if (originalOutcome) {
            ...
            return {
              ...outcome,
              tla_tasks: originalOutcome.tla_tasks.map((task) => ({ ...task })),
            };
          }
    ...
    return {
      course_outcomes: courseOutcomes.map((outcome) => ({
        ...
        tla_assessment_method: {
          ...
          learning_resources: outcome.tla_assessment_method.learning_resources,
        },
      })),
    };
  },

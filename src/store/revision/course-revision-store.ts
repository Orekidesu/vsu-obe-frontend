...
export const createCourseRevisionStore = (curriculumCourseId: string) => {
  return create<CourseRevisionState>()(
    persist(
      (set, get) => ({
        currentCourse: null,
      ...
      {
        name: `course-revision-${curriculumCourseId}`, // unique name per course

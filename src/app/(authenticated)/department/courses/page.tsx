      ...
      <div className="bg-white rounded-lg shadow-md p-8 max-w-2xl w-full">
        ...
        <div className="my-6 p-4 bg-blue-50 border border-blue-100 rounded-md">
          ...
          <p className="text-gray-600">
            The courses management feature is currently under development and
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex items-center p-3 border rounded-md">
            ...
            <span className="text-sm text-gray-600">View course schedules</span>
          </div>
          <div className="flex items-center p-3 border rounded-md">
            <Clock className="text-gray-500 mr-3" size={20} />
            <span className="text-sm text-gray-600">Track course progress</span>
          </div>
        </div>
